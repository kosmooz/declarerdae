...
import { validateStepFields, isPhoneValid, isPrefixValid, GEODAE_PREFIXES } from "@/lib/validation";
export type { StepErrors } from "@/lib/validation";

const PARENT_FIELDS_EXCLUDE = new Set(["daeDevices", "exptComplement"]);

export const validateStep = validateStepFields;
